...
# USER PATHS
# ---------------------------------------------------------
RAW_FILE = Path(r"C:\Users\aadis\OneDrive\Documents\PlatformIO\Projects\IMU py\data\samples\jvyviyiiiu.txt")
CAL_FILE = Path(r"C:\Users\aadis\OneDrive\Documents\PlatformIO\Projects\IMU py\calibration_matrices\calibration_matrices_20251124_135024.txt")

# SAVE HERE (fixed output directory)
OUTPUT_DIR = Path(r"C:\Users\aadis\OneDrive\Documents\PlatformIO\Projects\IMU py\calibrated output")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
...
print(f"\nSaved calibrated data to:\n{OUTPUT_FILE}")
>>>>>>> de9397e59b2b4d35c9418bac3f9b93f6ded4b8a6
